...
inline ::google::protobuf::uint32 BidRequest_AdzInfo::creative_organize_format() const {
  // @@protoc_insertion_point(field_get:Tanx.BidRequest.AdzInfo.creative_organize_format)
...
inline void BidRequest_AdzInfo::set_creative_organize_format(::google::protobuf::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:Tanx.BidRequest.AdzInfo.creative_organize_format)
}
...
inline ::google::protobuf::uint32 BidRequest_AdzInfo::expandable() const {
  // @@protoc_insertion_point(field_get:Tanx.BidRequest.AdzInfo.expandable)
  return expandable_;
}
inline void BidRequest_AdzInfo::set_expandable(::google::protobuf::uint32 value) {
  set_has_expandable();
  expandable_ = value;
  // @@protoc_insertion_point(field_set:Tanx.BidRequest.AdzInfo.expandable)
}
